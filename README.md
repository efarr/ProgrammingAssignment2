...
Programming assignment #2 of the [R Programming course](https://www.coursera.org/course/rprog) as part of
the [Data Science specialization](https://www.coursera.org/specialization/jhudatascience/1) from Johns Hopkins
and Coursera.

The remainder of this readme is from the original assignment.
